                ...
                <div className="slider-from">
                    <div className="slider-content">
                        <div className="slider-content-text">
                            <h1 className="text-heading2 text-thir-color">Cà Phê Sữa Milano</h1>
                            <h2 className="text-heading4 text-four-color">Khối lượng tịnh</h2>
                            <p className="text-common-sub text-four-color">200g</p>
                            ...
                            <p className="text-common-sub text-four-color">Cafe rang xay</p>
                            <h2 className="text-heading4 text-four-color">Nhà sản xuất</h2>
                            <p className="text-common-sub text-four-color">Milano</p>
                    ...
                    <div className="slider-img">
                        <img className="hinhcaphe" src="assets/img/caphemilano.png" alt="" />
                    </div>
                </div>
            ...
            <div class="container-2">
                ...
                <div class="box-containr-2">
                    <div class="box-text-container-2">
                        ...
                        <p class="text-italic text-body1">15/6/2019</p>
                    ...
                    <div class="box-text-container-2">
                        ...
                        <p class="text-italic text-body1 margin-bot-16">15/6/2021</p>
                    ...
                    <div class="box-text-container-2">
                        ...
                        <p class="text-italic text-body1">5/12/2022</p>
                    ...
                    <div class="box-text-container-2">
                        ...
                        <p class="text-italic text-body1">1/2/2023</p>
                    ...
                    <div class="box-text-container-2">
                        ...
                        <p class="text-italic text-body1">5/3/2023</p>
